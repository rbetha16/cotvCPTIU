...
public class CPHomePage extends PageObject {
    ...
    public void waitUntilTitleAppears() {		
		UserName_Txt.withTimeoutOf(ProjectVariables.SECONDS_MAX_SLEEP, ChronoUnit.SECONDS).waitUntilVisible();       
    }
	...
	public void Login_to_the_ClientProfile_application(String URL) throws Exception {
		...
		UserName_Txt.withTimeoutOf(ProjectVariables.SECONDS_MAX_SLEEP, ChronoUnit.SECONDS).waitUntilVisible().clear();
	...
	public boolean User_navigates_to_Client_profile_application(String navigationlink) {
		...
		Publisher_Link.withTimeoutOf(ProjectVariables.SECONDS_MAX_SLEEP, ChronoUnit.SECONDS).waitUntilVisible().click();
	...
	public boolean logout_From_ClientProfile_Application() {
		...
		LogOut_Link.withTimeoutOf(ProjectVariables.SECONDS_MAX_SLEEP, ChronoUnit.SECONDS).waitUntilVisible()
				.click();
		
		SeleniumUtils.defaultWait(ProjectVariables.MID_TIME_OUT);
		return oCPHomePage.UserName_Txt.withTimeoutOf(ProjectVariables.SECONDS_MAX_SLEEP, ChronoUnit.SECONDS).waitUntilVisible()
				.isPresent();
	}
