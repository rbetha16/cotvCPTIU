...
public class InterpretiveUpdateSteps {
	...
	@Then("^user navigate Task to Rule Review and Validate Messeage \"([^\"]*)\"$")
	public void user_navigate_Task_to_Rule_Review_and_Validate_Messeage(String arg1) throws InterruptedException {
		
		oInterpretiveUpdateStepDef.ruleReviewErrorMsg(arg1);
